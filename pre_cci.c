# 1 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c"
...
# 1 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
# 2 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"35014277a3e54b16ada85749bcc4081f\",\"statu"
...
char *random_computer_id;
int think_time =5;
char *random_company_name;
int randomMonth;
int randomYear;
char expiryDate[6];
int randomDay;

# 3 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
# 4 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
# 5 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2

# 1 "TC_02_click_computer_name.c" 1
...
lr_end_transaction("TC_02_click_computer_name", 2);

lr_think_time(think_time);
	return 0;
}
# 6 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2

# 1 "TC_03_enter_computer_details.c" 1
...
lr_end_transaction("TC_03_enter_computer_details", 2);

	lr_think_time(think_time);
	return 0;
}
# 7 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2

# 1 "TC_04_search_computer_name.c" 1
...
lr_start_transaction("TC_04_search_computer_name");
	...
	web_url("computers_4", 
		...
		"Mode=HTML", 
		"LAST");
lr_end_transaction("TC_04_search_computer_name", 2);

	lr_think_time(think_time);
	return 0;
}
# 8 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2

# 1 "TC_05_select_computer_name.c" 1
...
lr_end_transaction("TC_05_select_computer_name", 2);

	lr_think_time(think_time);
	return 0;
}
# 9 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2

# 1 "TC_06_click_on_cancel.c" 1
...
lr_start_transaction("TC_06_click_on_cancel");
	...
	web_url("computers_5", 
		...
		"Mode=HTML", 
		"LAST");
lr_end_transaction("TC_06_click_on_cancel", 2);

	lr_think_time(think_time);
	return 0;
}
# 10 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
# 11 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
...
# 12 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\computer-database\\computer-database_application\\\\combined_computer-database_application.c" 2
